...
function render() {
    ...
    let camX = 3 * Math.sin(glMatrix.toRadian(90.0 * elapsedTime));
    let camY = 5 * Math.sin(glMatrix.toRadian(45.0 * elapsedTime)) + 5;
    let camZ = 3 * Math.cos(glMatrix.toRadian(90.0 * elapsedTime));
